...
ggplot(j40_select, aes(x = percentile, fill = definition_m_pctl))+
  ...
  scale_fill_discrete(name = "Census Tract Designation", labels = c("Not Disadvantaged", "Disadvantaged"))+
  labs(
...
ggplot(j40_select, aes(x = percentile, fill = definition_m_pctl))+
  ...
  scale_fill_discrete(name = "Census Tract Designation", labels = c("Not Disadvantaged", "Disadvantaged"))+
  labs(
      title = "Census Tracts by Disadvantaged Status and Percent Non-White",
      x = "Percent of Census Tract that is Non-White",
...
missing_tracts = j40_race %>%
  ...
  summarize(n = n())
missing_tracts
vis_miss(j40_race, warn_large_data = F)
